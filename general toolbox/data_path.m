...
basename='ARCTERX2022';
%basename='SUNRISE2021_WS';

%% lat/lon center

lon_c = 143; %.. modified for ARCTERX2022
lat_c =  19; %.. modified for ARCTERX2022
...
switch dictionary
    case 'vmp'
        ...
        ship_tmp = load('../../../met_data/tsg.mat'); %% modified for ARCTERX2022
        ship.das.lat=ship_tmp.M.lat;ship.das.lon=ship_tmp.M.lon;ship.das.time=ship_tmp.M.dnum;
